...
class AdminCarDetailPage extends StatefulWidget {
  ...
  @override
  _AdminCarDetailPageState createState() => _AdminCarDetailPageState();
}

class _AdminCarDetailPageState extends State<AdminCarDetailPage> {
  int _currentIndex = 0;
